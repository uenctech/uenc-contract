 ...
 * @LastEditTime: 2021-08-09 13:47:11
...
const int g_MaxNeedVerifyPreHashCount = 15;  //最大共识个数
...
const uint32_t g_MaxVinSize = 100;
const uint32_t g_MinExeCount = 100;
const uint32_t g_deployamount = 1000000;
...
uint64_t g_TxNeedPublicPledgeAmt = 5000000000;  // 5000 * DECIMAL_NUM
