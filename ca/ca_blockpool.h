/*
 * @Author: your name
 * @Date: 2021-08-02 14:06:52
 * @LastEditTime: 2021-09-02 14:26:32
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: \ebpc\ca\ca_blockpool.h
 */
...
const int VERSION_ZERO_MIN_HEIGHT = 430718;
...
public:
    ...
    void AddSyncBlock(const std::vector<CBlock> &blocks, const std::vector<std::string> &rollback_blocks_hash);
    void Process();
...
private:
    ...
    std::vector<std::string> rollback_blocks_hash_;
