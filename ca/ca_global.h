...
extern const int g_MaxNeedVerifyPreHashCount;
extern Sync* g_synch;
...
extern uint64_t g_TxNeedPublicPledgeAmt;
...
extern uint64_t g_minUnpledgeHeight;

extern const uint32_t g_MaxVinSize;
extern const uint32_t g_MinExeCount ;
extern const uint32_t g_deployamount ;
extern std::mutex rollbackLock;
extern int rollbackCount;

extern TransactionConfirmTimer g_RpcTransactionConfirm;

extern std::mutex rocksdb_mutex;
...
#define PLEDGE_PUBLIC_NET_LICENCE "publicNetLicence"       //公网质押类型
...
#define VIRTUAL_ACCOUNT_DEPLOY "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD"


// 质押类型
enum class PledgeType
{
    kPledgeType_Unknown = 0,
    kPledgeType_Node = 1,
    kPledgeType_Public = 2,
    kPledgeType_All = kPledgeType_Node | kPledgeType_Public,
};
