...
class TxDoubleSpendMsg;
class TxDoubleSpendMsgDefaultTypeInternal;
extern TxDoubleSpendMsgDefaultTypeInternal _TxDoubleSpendMsg_default_instance_;
class TxMsg;
...
template<> ::TxDoubleSpendMsg* Arena::CreateMaybeMessage<::TxDoubleSpendMsg>(Arena*);
...
class BuildBlockBroadcastMsg :
 ...
 public:
  ...
  virtual ~BuildBlockBroadcastMsg();
  ...
  inline BuildBlockBroadcastMsg* New() const final {
    return CreateMaybeMessage<BuildBlockBroadcastMsg>(nullptr);
  }

  BuildBlockBroadcastMsg* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class TxPendingBroadcastMsg :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 prevblkheight() const;
  void set_prevblkheight(::PROTOBUF_NAMESPACE_ID::uint64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_prevblkheight() const;
  void _internal_set_prevblkheight(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 prevblkheight_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_ca_5fprotomsg_2eproto;
};
// -------------------------------------------------------------------
...
class TxDoubleSpendMsg :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:TxDoubleSpendMsg) */ {
 public:
  TxDoubleSpendMsg();
  virtual ~TxDoubleSpendMsg();

  TxDoubleSpendMsg(const TxDoubleSpendMsg& from);
  TxDoubleSpendMsg(TxDoubleSpendMsg&& from) noexcept
    : TxDoubleSpendMsg() {
    *this = ::std::move(from);
  }

  inline TxDoubleSpendMsg& operator=(const TxDoubleSpendMsg& from) {
    CopyFrom(from);
    return *this;
  }
  inline TxDoubleSpendMsg& operator=(TxDoubleSpendMsg&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const TxDoubleSpendMsg& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const TxDoubleSpendMsg* internal_default_instance() {
    return reinterpret_cast<const TxDoubleSpendMsg*>(
               &_TxDoubleSpendMsg_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    18;

  friend void swap(TxDoubleSpendMsg& a, TxDoubleSpendMsg& b) {
    a.Swap(&b);
  }
  inline void Swap(TxDoubleSpendMsg* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline TxDoubleSpendMsg* New() const final {
    return CreateMaybeMessage<TxDoubleSpendMsg>(nullptr);
  }

  TxDoubleSpendMsg* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TxDoubleSpendMsg>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const TxDoubleSpendMsg& from);
  void MergeFrom(const TxDoubleSpendMsg& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(TxDoubleSpendMsg* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "TxDoubleSpendMsg";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:TxDoubleSpendMsg)
 private:
  class _Internal;
...
inline void BuildBlockBroadcastMsg::set_version(const std::string& value) {
  _internal_set_version(value);
...
inline void BuildBlockBroadcastMsg::set_version(std::string&& value) {
  
  version_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:BuildBlockBroadcastMsg.version)
}
inline void BuildBlockBroadcastMsg::set_version(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  version_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:BuildBlockBroadcastMsg.version)
}
inline void BuildBlockBroadcastMsg::set_version(const char* value, size_t size) {
  
  version_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:BuildBlockBroadcastMsg.version)
}
...
inline void BuildBlockBroadcastMsg::set_blockraw(const std::string& value) {
...
inline void BuildBlockBroadcastMsg::set_blockraw(std::string&& value) {
  
  blockraw_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:BuildBlockBroadcastMsg.blockRaw)
}
inline void BuildBlockBroadcastMsg::set_blockraw(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  blockraw_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:BuildBlockBroadcastMsg.blockRaw)
}
inline void BuildBlockBroadcastMsg::set_blockraw(const void* value, size_t size) {
  
  blockraw_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:BuildBlockBroadcastMsg.blockRaw)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 TxPendingBroadcastMsg::_internal_prevblkheight() const {
  return prevblkheight_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 TxPendingBroadcastMsg::prevblkheight() const {
  // @@protoc_insertion_point(field_get:TxPendingBroadcastMsg.prevBlkHeight)
  return _internal_prevblkheight();
}
inline void TxPendingBroadcastMsg::_internal_set_prevblkheight(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  prevblkheight_ = value;
}
inline void TxPendingBroadcastMsg::set_prevblkheight(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
// string version = 1;
inline void TxDoubleSpendMsg::clear_version() {
  version_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& TxDoubleSpendMsg::version() const {
  // @@protoc_insertion_point(field_get:TxDoubleSpendMsg.version)
  return _internal_version();
}
inline void TxDoubleSpendMsg::set_version(const std::string& value) {
  _internal_set_version(value);
  // @@protoc_insertion_point(field_set:TxDoubleSpendMsg.version)
}
inline std::string* TxDoubleSpendMsg::mutable_version() {
  // @@protoc_insertion_point(field_mutable:TxDoubleSpendMsg.version)
  return _internal_mutable_version();
}
inline const std::string& TxDoubleSpendMsg::_internal_version() const {
  return version_.GetNoArena();
}
inline void TxDoubleSpendMsg::_internal_set_version(const std::string& value) {
  
  version_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void TxDoubleSpendMsg::set_version(std::string&& value) {
  
  version_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:TxDoubleSpendMsg.version)
}
inline void TxDoubleSpendMsg::set_version(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  version_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:TxDoubleSpendMsg.version)
}
inline void TxDoubleSpendMsg::set_version(const char* value, size_t size) {
  
  version_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:TxDoubleSpendMsg.version)
}
inline std::string* TxDoubleSpendMsg::_internal_mutable_version() {
  
  return version_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* TxDoubleSpendMsg::release_version() {
  // @@protoc_insertion_point(field_release:TxDoubleSpendMsg.version)
  
  return version_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void TxDoubleSpendMsg::set_allocated_version(std::string* version) {
  if (version != nullptr) {
  ...
  version_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), version);
  // @@protoc_insertion_point(field_set_allocated:TxDoubleSpendMsg.version)
}

// repeated .CTransaction txs = 2;
inline int TxDoubleSpendMsg::_internal_txs_size() const {
  return txs_.size();
}
inline int TxDoubleSpendMsg::txs_size() const {
  return _internal_txs_size();
}
inline ::CTransaction* TxDoubleSpendMsg::mutable_txs(int index) {
  // @@protoc_insertion_point(field_mutable:TxDoubleSpendMsg.txs)
  return txs_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CTransaction >*
TxDoubleSpendMsg::mutable_txs() {
  // @@protoc_insertion_point(field_mutable_list:TxDoubleSpendMsg.txs)
  return &txs_;
}
inline const ::CTransaction& TxDoubleSpendMsg::_internal_txs(int index) const {
  return txs_.Get(index);
}
inline const ::CTransaction& TxDoubleSpendMsg::txs(int index) const {
  // @@protoc_insertion_point(field_get:TxDoubleSpendMsg.txs)
  return _internal_txs(index);
}
inline ::CTransaction* TxDoubleSpendMsg::_internal_add_txs() {
  return txs_.Add();
}
inline ::CTransaction* TxDoubleSpendMsg::add_txs() {
  // @@protoc_insertion_point(field_add:TxDoubleSpendMsg.txs)
  return _internal_add_txs();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CTransaction >&
TxDoubleSpendMsg::txs() const {
  // @@protoc_insertion_point(field_list:TxDoubleSpendMsg.txs)
  return txs_;
}
